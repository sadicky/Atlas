                        ...
                        <div class="panel panel-default">
                          ...
                          <div class="panel-body">
                            ...
                            <div class="table-responsive">
                              <table class="table table-striped table-condensed table-bordered table-hover" id="myTable">
                                <thead>
                                  <tr>
                                    <th>#</th>
                                    <th>Client</th>
                                      ...
                                      <td>
                                        <div class="btn-group">
                                          ...
                                          <ul class="dropdown-menu">
                                            <li><a href="index.php?page=order&o=editOrd&i=<?= $vente->ID ?>" id="editOrderModalBtn"> <i class="glyphicon glyphicon-edit"></i> Edit</a></li>

                                            <li><a type="button" onclick="printOrder(<?= $vente->ID ?>)"> <i class="glyphicon glyphicon-print"></i> Imprimer </a></li>

                                            <li><a type="button" data-toggle="modal" data-target="#removeOrderModal" id="removeOrderModalBtn" onclick="removeOrder(<?= $vente->ID ?>)"> <i class="glyphicon glyphicon-trash"></i> Supprimer</a></li>
                                          </ul>
                                        </div>
                                      </td>
                                    </tr>
