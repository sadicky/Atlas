              ...
              <?php if ($_GET['o'] == 'add') : ?>
                ...
                <form class="form-horizontal" method="POST" action="Public/script/createOrderm.php" id="createOrderForm">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input type="date" class="form-control" required id="datev" name="datev" autocomplete="off" />
                    </div>
                  </div>
                  <!--/form-group-->
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" required id="client" name="client" placeholder="Nom du Client" autocomplete="off" />
                    </div>
                  </div>
                  <!--/form-group-->
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" required id="tel" name="tel" placeholder="Numero du client" autocomplete="off" />
                    </div>
                  </div>
                  <!--/form-group-->
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-9">
                        <select class="form-control" name="paymentStatus" required id="paymentStatus">
                          <option value="">~~SELECT~~</option>
...
if (row) {
  ...
  if (productId == "") {
    ...
    $.ajax({
      url: 'Public/script/fetchSelectedProductm.php',
      type: 'post',
      data: {
        productId: productId
      },
 ...
 // /documernt
  ...
  function addRow() {
    ...
    $.ajax({
      url: 'Public/script/fetchProductDatam.php',
      type: 'post',
      dataType: 'json',
      success: function(response) {
  ...
  function paymentOrder(orderId = null) {
    if (orderId) {
      ...
      $.ajax({
        url: 'Public/script/fetchOrderDatam.php',
        type: 'post',
        data: {
          orderId: orderId
        },
