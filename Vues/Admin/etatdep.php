			...
			<div class="row">
				<div class="col-xs-6 col-md-3">
					<div class="panel panel-default">
						<div class="panel-body easypiechart-panel">
							...
							$db = getConnection();
							$tdate = date('Y-m-d');
							$sql="select sum(MONTANT)  as TOTAL from tbl_depenses WHERE DATE='$tdate';";
							$req=$db->query($sql);
							$req->execute();
				...
				<div class="col-xs-6 col-md-3">
					<div class="panel panel-default">
						...
						$sql="select sum(MONTANT)  as TOTAL from tbl_depenses WHERE DATE='$ydate';";
						$req=$db->query($sql);
						$req->execute();
						$g=$req->fetch(PDO::FETCH_OBJ);
				...
				<div class="panel panel-default">
					...
					$crrntdte=date("Y-m-d");
					$query="select sum(MONTANT)  as TOTAL from tbl_depenses  WHERE DATE between '$pastdate' and '$crrntdte'";
					$req=$db->query($query);
					$req->execute();
					$g=$req->fetch(PDO::FETCH_OBJ);
					$sum_weekly=$g->TOTAL;
				...
				$crrntdte=date("Y-m-d");
				$sql="select sum(MONTANT)  as TOTAL from tbl_depenses  WHERE DATE between '$monthdate' and '$crrntdte'";
				$req=$db->query($sql);
				$req->execute();
				$g=$req->fetch(PDO::FETCH_OBJ);
				$sum_monthly=$g->TOTAL;
		...
		<div class="row">
			<div class="col-xs-6 col-md-6">
				<div class="panel panel-default">
					...
					//Yearly 
					$cyear= date("Y");
					$query="select sum(MONTANT)  as TOTAL from tbl_depenses  WHERE (year(DATE)='$cyear') ";
					$req=$db->query($query);
					$req->execute();
					$g=$req->fetch(PDO::FETCH_OBJ);
					$sum_yearly=$g->TOTAL;
...
<div class="col-xs-6 col-md-6">
		<div class="panel panel-default">
			<?php
				//Yearly Expense
				$query="select sum(MONTANT)  as TOTAL from tbl_depenses";
				$req=$db->query($query);
					$req->execute();
					$g=$req->fetch(PDO::FETCH_OBJ);
					$sum_total=$g->TOTAL;
