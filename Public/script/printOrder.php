...
<table align="center" class="table" style="width: 100%;border:1px solid black;margin-bottom: 10px;">
               <tbody>
                  ...
                  <tr></tr>
                  <tr>
                     <td colspan="3" style="font-style: italic;font-weight: 600;text-decoration: underline;font-size: 25px;">Atlas</td>
                  </tr>
                  <tr>
                     <td colspan="3" >Boulevard du 30 juin,</td>
                  </tr>
                  <tr>
                     <td colspan="3" >Kisangani</td>
                  </tr>
                  <tr>
                  ...
                  $x = 1;
            while($row = $orderItemResult->fetchObject()) {       
