...
$caisse = new Caisse();
 ...
 $idu = 13;
 $add = null;
  $add = $caisse-> setCaisse($client,$tel,$adresse,$motif,$montant,$date,$dateins,$statut,$idu);
  if(!empty($add)){
	...
	echo "<script>window.location.href='http://localhost/atlasline/index.php?page=caisseE'</script>"; 
}
  else{
